...
// ---------------- OUTPUT FORM HTML ----------------
?>
<div class="mb-2"><strong>User:</strong> <?= htmlspecialchars($appointment['user_name']) ?></div>
<div class="mb-2"><strong>Date:</strong> <?= date('d M Y', strtotime($appointment['appointment_date'])) ?></div>
<div class="mb-4"><strong>Time:</strong> <?= date('H:i', strtotime($appointment['appointment_time'])) ?></div>
